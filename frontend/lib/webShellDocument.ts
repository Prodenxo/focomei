...
(function () {
  ...
  window.setTimeout(function () {
    ...
    splash.innerHTML =
      '<p style="margin:0 16px;text-align:center;max-width:380px;line-height:1.5;color:#475569">' +
      'O app demorou para carregar. Isso costuma ser <strong>cache antigo</strong> após atualização do site.</p>' +
      '<button type="button" style="margin-top:12px;padding:10px 18px;border:0;border-radius:8px;background:#2563eb;color:#fff;font-weight:600;cursor:pointer" ' +
      'onclick="window.__mfHardReload(true)">Atualizar e limpar dados locais</button>' +
      '<p style="margin:12px 0 0;font-size:12px;color:#94a3b8">Ou use Ctrl+Shift+R (hard refresh)</p>';
  }, BOOT_MS);
